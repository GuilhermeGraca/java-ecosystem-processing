...
public class DNA {
    ...
    public DNA(DNA dna, boolean mutate){
        ...
        deltaPursuit = dna.deltaPursuit; //deltaTPursuit
    ...
    private void mutate() {
        //pode se mudar outros parametros nas mutações
        maxSpeed += random(-0.2f,0.2f);//pode ficar mais lento ou mais rapido
        maxSpeed = Math.max(0,maxSpeed);//nunca é negativo
    }
